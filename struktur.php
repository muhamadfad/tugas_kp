...
<head>
    ...
    <!-- site metas -->
    <title>Struktur | Perpustakaan IAIN Kendari</title>
...
<body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-content">
                                ...
                                <a href="#" style="color : #000; font-weight : bold">STRUKTUR</a>
                            </div>
                        </li>
                        <li class="nav-item">
    ...
    <div class="about_section layout_padding">
        <div class="container mt-5 mb-5">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="services_taital mb-4"><span style="color: black;">Struktur </span>Organisasi</h1>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-sm-12 text-center">
                    <img src="images/Struktur.jpg" alt="Struktur Organisasi"
                        style="width: 525px; ;max-width: 100%; height: auto;">
                </div>
            </div>
        </div>
    </div>
