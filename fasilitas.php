...
<head>
    ...
    <!-- site metas -->
    <title>Fasilitas | Perpustakaan IAIN Kendari</title>
...
<body>
    ...
    <div class="about_section layout_padding">
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="services_taital mb-4"><span style="color: black;">Fasi</span>litas</h1>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="carousel-item active">
                                    <div class="row mb-4">
                                        <div class="col-md-4">
                                            ...
                                            <div class="project_main">
                                                <h2 class="work_text text-center">Area Wifi</h2>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="container_main">
                                            ...
                                            <div class="project_main">
                                                <h2 class="work_text text-center">Ruangan Rapat</h2>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="container_main">
                                            ...
                                            <div class="project_main">
                                                <h2 class="work_text text-center">Ruangan Multimedia dan IT</h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4 justify-content-center">
                                        <div class="col-md-4">
                                            ...
                                            <div class="project_main">
                                                <h2 class="work_text text-center">Loker Penyimpanan Barang</h2>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="container_main">
                                                ...
                                                <div class="project_main">
                                                    <h2 class="work_text text-center">Corner di Perpustakaan</h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
