...
<head>
    ...
    <!-- site metas -->
    <title>Pengumuman | Perpustakaan IAIN Kendari</title>
...
<body>
    ...
    <div class="about_section layout_padding">
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="services_taital mb-4"><span style="color: black;">Pengu</span>muman</h1>
                </div>
            </div>
        </div>
    </div>
    <div class="projects_section mb-0">
        <div class="container">
